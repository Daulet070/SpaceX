		...
		<div className="container">
			<ul className="calendar-list">
				<li className="calendar-item">
					<article className="launches">
						<div className="launches-image">
							<img src="https://images2.imgbox.com/3c/0e/T8iJcSN3_o.png" alt="FalconSat" />
				...
				<li className="calendar-item">
					<article className="launches">
						<div className="launches-image">
							<img src="https://images2.imgbox.com/4f/e3/I0lkuJ2e_o.png" alt="DemoSat" />
						</div>
						<div className="launches-content">
				...
				<li className="calendar-item">
					<article className="launches">
						<div className="launches-image">
							<img src="https://images2.imgbox.com/3d/86/cnu0pan8_o.png" alt="Trailblazer" />
						</div>
						<div className="launches-content">
							<h2 className="launches-title">
				...
				<li className="calendar-item">
					<article className="launches">
						<div className="launches-image">
							<img src="https://images2.imgbox.com/e9/c9/T8CfiSYb_o.png" alt="RatSat" />
						</div>
						<div className="launches-content">
							<h2 className="launches-title">
